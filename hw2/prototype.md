...
| ---- | ---------- | -------------------- |
| Данные | M5 (Kaggle) + DVC | Open data; экономит месяцы сбора; даёт честную внешнюю валидацию через Kaggle leaderboard |
...
| Малая выборка пилотных пользователей (5–7) | высокая | среднее | Честно прописываем в evaluation: пилот качественный и directional, не statistically significant |
